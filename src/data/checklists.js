...
// Fonte: Planilhas DPL Construções — Contrato Equatorial 1021/2024
// ================================================================
...
export const CHECKLISTS = {
  CORTE: {
    ...
    PRODUTIVO: {
      ...
      items: [
        ...
        { id: 4, cat: 'DESEMPENHO',    p: 'O corte foi executado no local indicado na OS?' },
        { id: 5, cat: 'QUALIDADE',     p: 'O local informado no corte condiz com o real?' },
        { id: 6, cat: 'QUALIDADE',     p: 'Preenchido corretamente as informações no PDA (medidor, vizinhos, leitura, poste, placa trafo, etc)?' },
        { id: 7, cat: 'QUALIDADE',     p: 'Foi feito o registro com foto conforme diretriz (local do corte, fachada, mini toi, etc)?' },
        { id: 8, cat: 'QUALIDADE',     p: 'Havendo necessidade, foi deixado folheto referente à atividade em execução?' },
        { id: 9, cat: 'DESEMPENHO',    p: 'Equipe solicitou comprovante de pagamento das faturas apontadas na OS?' },
        { id: 10, cat: 'DESEMPENHO',   p: 'Foi confirmado pagamento de todas as faturas apontadas na OS?' },
        { id: 11, cat: 'QUALIDADE',    p: 'Baixou a nota com o motivo correto?' },
        { id: 12, cat: 'DESEMPENHO',   p: 'Executou a atividade num tempo adequado?' },
      ],
    },
    IMPRODUTIVO: {
      label: 'Improdutivo',
  ...
  // RELIGA será adicionada aqui quando o checklist estiver pronto
  // RELIGA: { label: 'Religação', emoji: '⚡', PRODUTIVO: {...}, IMPRODUTIVO: {...} }
}
